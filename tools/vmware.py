...
def main():
    ...
    vmx, serial = configure(directory, args)
    ...
    try:
        while time.monotonic() - start < args.timeout:
            ...
            if args.expect == "reboot":
                ...
                if ": error: " in output or "Exception Type" in output:
                    raise RuntimeError(output)
                markers = MARKERS if args.expect == "ready" else ("kernel: all processors online", "kernel: ready")
